...
import com.feather.game.npc.godwars.GodWarMinion;
import com.feather.game.npc.godwars.armadyl.GodwarsArmadylFaction;
import com.feather.game.npc.godwars.armadyl.KreeArra;
import com.feather.game.npc.godwars.bandos.GeneralGraardor;
import com.feather.game.npc.godwars.bandos.GodwarsBandosFaction;
import com.feather.game.npc.godwars.saradomin.CommanderZilyana;
import com.feather.game.npc.godwars.saradomin.GodwarsSaradominFaction;
import com.feather.game.npc.godwars.zammorak.GodwarsZammorakFaction;
import com.feather.game.npc.godwars.zammorak.KrilTstsaroth;
import com.feather.game.npc.godwars.zaros.Nex;
import com.feather.game.npc.godwars.zaros.NexMinion;
import com.feather.game.npc.kalph.KalphiteQueen;
import com.feather.game.npc.nomad.FlameVortex;
import com.feather.game.npc.nomad.Nomad;
import com.feather.game.npc.others.Bork;
import com.feather.game.npc.others.ItemHunterNPC;
import com.feather.game.npc.others.LivingRock;
import com.feather.game.npc.others.Lucien;
import com.feather.game.npc.others.MasterOfFear;
import com.feather.game.npc.others.MercenaryMage;
import com.feather.game.npc.others.PestMonsters;
import com.feather.game.npc.others.Revenant;
import com.feather.game.npc.others.TormentedDemon;
import com.feather.game.npc.slayer.Strykewyrm;
import com.feather.game.npc.sorgar.Elemental;
...
import com.feather.game.player.content.LivingRockCavern;
...
public final class World {
	...
	public static final boolean removeGroundItem(Player player,
		...
		if (floorItem.getId() == 995) {
			player.getPouch().handleMoneyPouch(false, false, false, floorItem.getAmount(), floorItem.getAmount());
		}
