...
public final class QueenBlackDragonController extends Controler {
	...
	private static final int[][][] PLATFORM_STEPS = {
		{	{ 88, 86 }, { 88, 87 }, { 88, 88 }, { 88, 89 }, { 88, 90 }, { 88, 91 },
			{ 89, 91 }, { 89, 90 }, { 89, 89 }, { 89, 88 }, { 89, 87 }, { 89, 86 }, { 90, 86 }, { 90, 87 },
			{ 90, 88 }, { 90, 89 }, { 90, 90 }, { 90, 91 }, { 91, 91 }, { 91, 90 }, { 91, 89 }, { 91, 88 },
			{ 91, 87 }, { 92, 87 }, { 92, 88 }, { 92, 89 }, { 92, 90 }, { 92, 91 }, { 93, 91 }, { 93, 90 },
			{ 93, 89 }, { 93, 88 }, { 94, 88 }, { 94, 89 }, { 94, 90 }, { 94, 91 }, { 95, 91 }, { 95, 90 },
			{ 95, 89 }, { 96, 89 }, { 96, 90 }, { 96, 91 }, { 97, 91 }, { 97, 90 }, { 98, 90 }, { 98, 91 }, { 99, 91 } 
		},
		{
			{ 106, 91 }, { 106, 90 }, { 106, 89 }, { 106, 88 }, { 106, 87 }, { 106, 86 }, 
			{ 105, 86 }, { 105, 87 }, { 105, 88 }, { 105, 89 }, { 105, 90 }, { 105, 91 }, { 104, 91 }, { 104, 90 },
			{ 104, 89 }, { 104, 88 }, { 104, 87 }, { 104, 86 }, { 103, 87 }, { 103, 88 }, { 103, 89 }, { 103, 90 },
			{ 103, 91 }, { 102, 91 }, { 102, 90 }, { 102, 89 }, { 102, 88 }, { 102, 87 }, { 101, 88 }, { 101, 89 },
			{ 101, 90 }, { 101, 91 }, { 100, 91 }, { 100, 90 }, { 100, 89 }, { 100, 88 }, { 99, 88 }, { 99, 89 },
			{ 99, 90 }, { 98, 89 }
		},
		{
			 { 99, 90 }, { 100, 90 }, { 100, 89 }, { 99, 89 }, { 98, 89 }, { 97, 89 }, { 95, 88 },
			 { 96, 88 }, { 97, 88 }, { 98, 88 }, { 99, 88 }, { 99, 87 }, { 98, 87 }, { 97, 87 },
			 { 96, 87 }, { 96, 86 }, { 97, 86 }, { 98, 86 }
		}
	};
				...
				try {
					...
					FadingScreen.unfade(player, time, new Runnable() {
						...
						public void run() {
							...
							player.getInterfaceManager().sendTab(player.getInterfaceManager().hasResizableScreen() ? 1 : 0, 1285);//1133);
	...
	public boolean processObjectClick1(GameObject object) {
		...
		if (object.getId() == 70790) {
			...
			FadingScreen.fade(player, new Runnable() {
				@Override
				public void run() {
					player.getPackets().sendGameMessage("You descend the stairs that appeared when you defeated the Queen Black Dragon.");
	...
	public void process() {
		...
		if (player.getY() < base.getY() + 28) {
			...
			if (platformStand++ == 3) {
				player.getPackets().sendGameMessage("You are damaged for standing too long on the raw magical platforms.");
