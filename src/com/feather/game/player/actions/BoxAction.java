...
public class BoxAction extends Action {
	...
	public enum HunterNPC {
		...
		CARNIVOROUS_CHINCHOMPA(5080, new Item[] {new Item(10034, 1)}, 63, 265, HunterEquipment.BOX, 28558, 19192, new Animation(5184), new Animation(5185)), 

		FERRT(5081,  new Item[] {new Item(10092)}, 27, 115, HunterEquipment.BOX, 19189, 19192, new Animation(5191), new Animation(5192)),

		GECKO(6916,  new Item[] {new Item(12184)}, 27, 100, HunterEquipment.BOX, 19190, 19192, new Animation(8362), new Animation(8361)), 

		RACCOON(7272,  new Item[] {new Item(12487)}, 27, 100, HunterEquipment.BOX, 19191, 19192, new Animation(7726), new Animation(7727)), 

		MONKEY(6942, new Item[] {new Item(2201)}, 27, 100, HunterEquipment.BOX, 28557, 19192, new Animation(8343), new Animation(8345)), 

		CRIMSON_SWIFT(5073, new Item[] { new Item(10088), new Item(526, 1), new Item(9978, 1) }, 1, 34, HunterEquipment.BRID_SNARE, 19180, 19174, new Animation(6775), new Animation(6774)), 

		GOLDEN_WARBLER(5075, new Item[] { new Item(1583), new Item(526, 1), new Item(9978, 1) }, 5, 48, HunterEquipment.BRID_SNARE, 19184, 19174, new Animation(6775), new Animation(6774)), 

		COPPER_LONGTAIL(5076, new Item[] { new Item(10091), new Item(526, 1), new Item(9978, 1) }, 9, 61, HunterEquipment.BRID_SNARE, 19186, 19174, new Animation(6775), new Animation(6774)), 

		CERULEAN_TWITCH(5074, new Item[] { new Item(10089), new Item(526, 1), new Item(9978, 1) }, 11, 64.67, HunterEquipment.BRID_SNARE, 19182, 19174, new Animation(6775), new Animation(6774)), 

		TROPICAL_WAGTAIL(5072, new Item[] { new Item(10087), new Item(526, 1), new Item(9978, 1) }, 19, 95.2, HunterEquipment.BRID_SNARE, 19178, 19174, new Animation(6775), new Animation(6774)), 

		WIMPY_BIRD(7031, new Item[] { new Item(11525, 1), new Item(526, 1), new Item(9978, 1) }, 39, 167, HunterEquipment.BRID_SNARE, 28930, 19174, new Animation(6775), new Animation(6774)),

		SPINED_LARUPIA(5104, new Item[] {new Item(532, 1), new Item(10093, 1)}, 31, 180, HunterEquipment.LARUPIA_PITFALL, 19232, -1, new Animation(-1), new Animation(5231));//might as well try converting it lol
		...
		private HunterNPC(int npcId, Item[] item, int level, double xp, HunterEquipment hunter, int successfulTransformObjectId, int failedTransformObjectId, Animation successCatchAnim, Animation failCatchAnim) {
			this.npcId = npcId;
			this.item = item;
			this.level = level;
			this.xp = xp;
	...
	public enum HunterEquipment {
		...
		BOX(10008, 19187, new Animation(5208), 27), BRID_SNARE(10006, 19175, new Animation(5207), 1), LARUPIA_PITFALL(-1, 19232, new Animation(5207), 31);
