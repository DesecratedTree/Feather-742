...
import com.feather.game.minigames.clanwars.WallHandler;
	...
	public static boolean processAdminCommand(final Player player,
		...
		if (clientCommand) {
			...
			case "unban":
				...
				return true;
			case "grave":
				GraveStone.sendRespawnInterface(player);
				return true;
			case "godwars":
			...
			case "spirit":
				...
				for (int x = 0; x < 100; x++) {
					player.getPackets().sendUnlockIComponentOptionSlots(864, x, 0, 100, 0);
				}
				return true;
			case "quest":
...
//				return true;
	...
	public static boolean processModCommand(Player player, String[] cmd,
		...
		if (clientCommand) {
			...
			case "runes":
				...
				player.getInventory().addItem(559, 10000);
				player.getInventory().addItem(560, 10000);
				player.getInventory().addItem(561, 10000);
				player.getInventory().addItem(562, 10000);
				player.getInventory().addItem(563, 10000);
				player.getInventory().addItem(564, 10000);
				player.getInventory().addItem(565, 10000);
				player.getInventory().addItem(566, 10000);
				return true;
	...
	public static void sendYell(Player player, String message, boolean staffYell) {
		...
		World.sendWorldMessage("<col="+(player.getYellColor() == "ff0000" || player.getYellColor() == null ? "1589FF" : player.getYellColor())+">World:</col> <img=1>"
