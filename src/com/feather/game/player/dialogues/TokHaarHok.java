	...
	public void run(int interfaceId, int componentId) {
		...
		case 6:
			...
			case 3:
				...
				sendOptionsDialogue("Accept the "+ (stage == 4 ? "TokHaar-Kal" : "uncut onyx") + "?",
						"Yes.", "No.");
			break;
			case 4:
			case 5:
				if (componentId == OPTION_1) {
					player.getTemporaryAttributtes().put("FightKilnReward", stage == 4 ? 0 : 1);
					stage = 6;
