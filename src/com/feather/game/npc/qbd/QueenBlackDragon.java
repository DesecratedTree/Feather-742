...
public final class QueenBlackDragon extends NPC {
	...
	private static final QueenAttack[] PHASE_1_ATTACKS = {
		new FireBreathAttack(), new MeleeAttack(), new RangeAttack(), 
		new FireWallAttack()
	};
	...
	private static final QueenAttack[] PHASE_4_ATTACKS = { //Super fire attack twice, to make it more often.
		new FireBreathAttack(), new TimeStopAttack(), new MeleeAttack(), new SuperFireAttack(), 
		new RangeAttack(), new FireWallAttack(), new SuperFireAttack(), 
		new ChangeArmour(), new SoulSummonAttack(), new SoulSiphonAttack(), new TimeStopAttack()
	};
